Rama a entregar (main)

Rama de desarrollo ==dev==

>[!important]
>Cada literal debe tener su .h y .cpp (eje. reorganizacion-tablero.h Y reorganiacion-tablero.cpp)


- [ ] Vista del tablero como bits (Nataly)
- [ ] Vista del tablero como caracteres (elmer)

---

- [ ] Reorganizacion del tablero (Elmer)
- [ ] Modificacion dinamica de la estructura del tablero (operaciones del usuario) (Nataly)
- [ ] Modificon real de la memoria (Elmer)
- [ ] Cascadas (Nataly)
- [ ] Estado del juego (Elmer)
